        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-2xl md:text-3xl text-white/80 mb-12 font-light max-w-4xl mx-auto">
              We are currently compiling our success stories to share with you. Check back soon to see our impact.
            </p>
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 border-0 px-10 py-7 text-lg font-semibold"
              >
                Get in Touch
